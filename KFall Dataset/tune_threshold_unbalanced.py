...
OUTPUT_PLOT_PATH = 'KFall Dataset/threshold_tuning_cnn_lstm_unbalanced.png'
BATCH_SIZE = 64
...
def tune_thresholds():
    ...
    plt.axvline(x=best_threshold['Threshold'], color='r', linestyle='--', 
                label=f"Best Threshold (F1-Score): {best_threshold['Threshold']:.2f}")

    plt.title('Precision, Recall, and F1-Score vs. Threshold for CNN-LSTM (Unbalanced)')
