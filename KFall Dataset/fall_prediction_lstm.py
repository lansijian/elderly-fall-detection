...
def plot_training_history(history):
    ...
    # 使用英文标签
    loss_title = 'Training and Validation Loss'  # 训练和验证损失
    metrics_title = 'Validation Accuracy and AUC'  # 验证准确率和AUC
...
def main():
    """主函数"""
    # 主函数
    print("=== LSTM-based Fall Prediction Model ===\n")  # 基于LSTM的跌倒预测模型
    ...
    print(f"\n=== 训练和评估完成 ===")  # 训练和评估完成
    print(f"最佳模型已保存为 best_model.pth")  # 最佳模型已保存
    print(f"混淆矩阵已保存为 confusion_matrix.png")  # 混淆矩阵已保存
    print(f"训练历史已保存为 training_history.png")  # 训练历史已保存
